...
/**
 * REST controller for managing {@link fr.cyr.marmite.app.domain.Orders}.
 */
@RestController
@RequestMapping("/api")
public class OrdersResource {
    ...
    public ResponseEntity<List<Orders>> getAllOrders(
        ...
        Page<Orders> page;
        if (eagerload) {
            page = ordersService.findAllWithEagerRelationships(pageable);
        } else {
            page = ordersService.findAll(pageable);
        }
