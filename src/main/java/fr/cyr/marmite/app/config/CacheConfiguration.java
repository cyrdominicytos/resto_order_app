...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, fr.cyr.marmite.app.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, fr.cyr.marmite.app.repository.UserRepository.USERS_BY_EMAIL_CACHE);
