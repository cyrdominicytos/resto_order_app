...
class ProductCategoryResourceIT {
    ...
    public static ProductCategory createEntity(EntityManager em) {
        ProductCategory productCategory = new ProductCategory().name(DEFAULT_NAME).order(DEFAULT_ORDER);
    ...
    public static ProductCategory createUpdatedEntity(EntityManager em) {
        ProductCategory productCategory = new ProductCategory().name(UPDATED_NAME).order(UPDATED_ORDER);
        return productCategory;
    }
    ...
    void createProductCategory() throws Exception {
        ...
        ProductCategory productCategory = productCategoryMapper.toDto(productCategory);
        ...
        assertThat(testProductCategory.getOrder()).isEqualTo(DEFAULT_ORDER);
    }
    ...
    void putExistingProductCategory() throws Exception {
        ...
        updatedProductCategory.name(UPDATED_NAME).order(UPDATED_ORDER);
        ProductCategory productCategory = productCategoryMapper.toDto(updatedProductCategory);
        ...
        assertThat(testProductCategory.getOrder()).isEqualTo(UPDATED_ORDER);
    }
    ...
    void fullUpdateProductCategoryWithPatch() throws Exception {
        ...
        partialUpdatedProductCategory.name(UPDATED_NAME).order(UPDATED_ORDER);
