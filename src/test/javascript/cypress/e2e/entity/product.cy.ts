...
describe('Product e2e test', () => {
  ...
  describe('new Product page', () => {
    ...
    it('should create an instance of Product', () => {
      ...
      cy.get(`[data-cy="createdDate"]`).type('2024-02-01T02:23').blur().should('have.value', '2024-02-01T02:23');

      cy.get(`[data-cy="updatedDate"]`).type('2024-01-31T12:06').blur().should('have.value', '2024-01-31T12:06');
