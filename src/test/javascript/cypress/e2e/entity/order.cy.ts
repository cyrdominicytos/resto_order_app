...
describe('Order e2e test', () => {
  ...
  const orderSample = { amount: 48577 };
  ...
  describe('new Order page', () => {
    ...
    it('should create an instance of Order', () => {
      cy.get(`[data-cy="amount"]`).type('92925').should('have.value', '92925');

      cy.get(`[data-cy="createdDate"]`).type('2024-02-01T07:09').blur().should('have.value', '2024-02-01T07:09');

      cy.get(`[data-cy="recoveryDate"]`).type('2024-01-31T18:25').blur().should('have.value', '2024-01-31T18:25');

      cy.get(`[data-cy="updatedDate"]`).type('2024-01-31T14:26').blur().should('have.value', '2024-01-31T14:26');
